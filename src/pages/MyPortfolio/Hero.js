...
const Hero = () => {
    return (
        ...
        justify-center items-center justify-items-center px-5 xl:px-44 2xl:px-56
         2xl:grid-cols-3 min-h-screen  xl:h-[40vh] 2xl:h-[100vh] bg-[#22252A] text-center xl:text-left'>
            <div className='w-8/12 mb-24'>
            ...
            <div className='mt-0 xl:mt-[-50px]'>
                ...
                <ul className='text-slate-300 flex justify-around flex-col xl:flex-row'>
                    <label>Skill - </label>
                    <li>JavaScript</li>
                    <li>React JS</li>
                    <li>Tailwind</li>
